...
// Dependências: JDK19, AntonioVandre >= 20231101, mXparser v.6.1 (Sagitara) (https://mathparser.org/).
...
public class JavaAntonioVandreEval
    {
    // Início definições de Antonio Vandré Pedrosa Furtunato Gomes.

    static String Version = "30-03-2025";
    ...
    public static void main(String[] args)
        ...
        boolean isCallSuccessful = License.iConfirmNonCommercialUse("Antonio Vandré Pedrosa Furtunato Gomes|sourceforge.net/u/antoniovandre");
